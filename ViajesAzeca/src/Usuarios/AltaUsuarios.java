	...
	public AltaUsuarios() {
		...
		btnCancelar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AltaDtb n=new AltaDtb();
				n.Limpiar(txtNombre, txtPass, txtPass1, txtAp_pat, txtAp_mat, txtUser);
			}
		});
		btnCancelar.setIcon(new ImageIcon(AltaUsuarios.class.getResource("/Imagenes/cancel_travel.png")));
